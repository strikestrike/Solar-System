...
* The file `src/routes/index.svelte` (or `src/routes/index.json.js`) corresponds to the root of your app. `src/routes/about/index.svelte` is treated the same as `src/routes/about.svelte`.
